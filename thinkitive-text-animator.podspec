#
#  Be sure to run `pod spec lint thinkitive-text-animator.podspec' to ensure this is a
...
* For best results run a ``NSTimer`` 60 times a second to get 60 frames per second and call ``updateCurrentTime(percentage: percentage)`` from ``NSTimer`` selector
  ...
  spec.homepage     = "https://thinkitivelab.com"
  ...
  spec.author             = { "Gints Osis" => "gints.osis1@gmail.com" }
  # Or just: spec.author    = "Gints Osis"
  # spec.authors            = { "Gints Osis" => "gints.osis1@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Gints Osis"
  ...
  spec.source = { :git => "https://github.com/gosis/thinkitive-text-animator.git", :tag => "#{1.0}" }
